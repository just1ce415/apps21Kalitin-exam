...
public class JSONApp {
    ...
    public static JsonObject sessionResult() {
        ...
        JsonObject OOPobj = new JsonObject(new JsonPair("course", new JsonString("OOP")),
                new JsonPair("mark", new JsonNumber(3)),
                new JsonPair("passed", new JsonBoolean(true)));
        JsonObject Engobj = new JsonObject(new JsonPair("course", new JsonString("English")),
                new JsonPair("mark", new JsonNumber(5)),
                new JsonPair("passed", new JsonBoolean(true)));
        JsonObject Mathobj = new JsonObject(new JsonPair("course", new JsonString("Math")),
                new JsonPair("mark", new JsonNumber(2)),
                new JsonPair("passed", new JsonBoolean(false)));
        JsonArray examsVal = new JsonArray(OOPobj, Engobj, Mathobj);
        JsonPair exam = new JsonPair("exams", examsVal);
